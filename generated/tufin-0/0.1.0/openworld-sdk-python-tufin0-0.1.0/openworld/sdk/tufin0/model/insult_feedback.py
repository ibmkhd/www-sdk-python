...
from .insult_detail import InsultDetail
...
class InsultFeedback(OrderPurchaseUpdateRequest):
    """@dataclass InsultFeedback

    Attributes:
        insult_detail(InsultDetail):
    """
    insult_detail: Optional[InsultDetail] = field(default=None, metadata=config(exclude=lambda f: f is None))
