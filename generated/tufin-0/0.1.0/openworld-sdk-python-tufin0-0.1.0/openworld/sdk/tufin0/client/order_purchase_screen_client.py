...
from openworld.sdk.tufin0.model.order_purchase_screen_request import OrderPurchaseScreenRequest
from openworld.sdk.tufin0.model.order_purchase_screen_response import OrderPurchaseScreenResponse
...
class OrderPurchaseScreenClient:
    def __init__(self, client_config: ClientConfig):
        ...
        os_name = os[0]
        os_version = os[1]
        sdk_metadata = f'open-world-sdk-python-tufin0/0.1.0'
